...
```
    ...
    <div id="quickLogScreen" class="hidden">
        <div class="close-button" id="closeQuickLogBtn">✕</div>
    ...
    <div id="manualLogScreen" class="hidden">
        <div class="close-button" id="closeManualLogBtn">✕</div>
        <div class="card">
    ...
    <div id="myDataScreen" class="hidden">
        <div class="close-button" id="closeMyDataBtn">✕</div>
        <div class="card">
...
<script>
        ...
        if (data.activeEpisode) {
            episodeOption = `
                <button class="option-button" data-action="episode-continue">
                    ⚠️ Continue Episode Log
                </button>
                <button class="option-button" data-action="episode-end">
                    ✓ I'm Feeling Functional Again
                </button>
            `;
        }
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-options">
                    ${episodeOption}
                    <button class="option-button" data-action="sleep">💤 Sleep</button>
                    <button class="option-button" data-action="work">🏢 Work</button>
                    <button class="option-button" data-action="friends">👥 Friends</button>
                    <button class="option-button" data-action="relationship">💕 Relationship</button>
                    <button class="option-button" data-action="internal">🧠 Internal</button>
                    <button class="option-button" data-action="positive">🌈 Positive</button>
                    <button class="option-button" data-action="episode">⚠️ Episode</button>
    ...
    function selectManualCategory(category) {
        ...
        if (category === 'episode-end') {
            ...
            showToast('Noted — glad you\'re feeling better ✓');
            closeManualLog();
            return;
        }
        ...
        if (isCustomCategory) {
            ...
            showToast(`${data.customCategories[category].name} log saved ✓`);
            closeManualLog();
            return;
        }
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToStart">← Back</button>
    ...
    function selectSleepType(type) {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToSleep">← Back</button>
    ...
    function renderWorkPersonSelect() {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToWork">← Back</button>
                    <button class="button small" id="savePartialBtn">Save As-Is</button>
                </div>
            </div>
        `;
    ...
    function selectWorkPerson(person) {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToPerson">← Back</button>
                    <button class="button small" id="savePartialBtn">Save As-Is</button>
                </div>
            </div>
        `;
    ...
    function selectWorkSituation(situation) {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToSituation">← Back</button>
    ...
    function selectFriend(person) {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToFriends">← Back</button>
                    <button class="button small" id="savePartialBtn">Save As-Is</button>
                </div>
            </div>
        `;
    ...
    function saveRelationshipLog(situation) {
        ...
        showToast('Relationship log saved ✓');
        closeManualLog();
    }
    ...
    function selectInternalState(state) {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToInternal">← Back</button>
    ...
    function selectPositiveType(type) {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToPositive">← Back</button>
                    <button class="button small" id="savePartialBtn">Save As-Is</button>
                </div>
            </div>
        `;
    ...
    function selectPositiveContext(context) {
        ...
        flow.innerHTML = `
            <div class="flow-screen">
                ...
                <div class="flow-actions">
                    <button class="button small back-button" id="backToContext">← Back</button>
            ...
            sequences.slice(0, 4).forEach(seq => {
                html += `
                    <div class="pattern-item">
                        <div class="pattern-title">${seq.first} → ${seq.second}</div>
                ...
                <div class="person-list" id="customPresetsList">
                    ${Object.entries(data.customPresets || {}).flatMap(([category, presets]) => 
                        presets.map((preset, i) => `
                            <div class="person-item">
                                <span>${DEFAULT_PRESETS[category]?.icon || '•'} ${preset}</span>
